    ...
    },
    {
      ...
      whales: [
        ...
        { id: 4, title: 'Whale 4 · Описываем и объясняем выбор', topics: [
          'Как выглядит эта вещь?','Описываем внешний вид одежды','Объясняем свой выбор','Уточняем, какой человек','Объясняем, что это такое','Описываем и объясняем выбор — закрепление'
        ]},
