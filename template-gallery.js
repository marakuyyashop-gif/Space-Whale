(() => {
  ...
  const examples = [
    ...
    { label: '12 · Порядок картинок', version: 1, id: 'picture-order-demo', kind: 'order', layout: 'image-grid', title: 'Put the activities in order.', instruction: 'Click the pictures in the order they are mentioned.', tokens: [{ id: 'internet', text: 'using the internet', image: 'assets/choice-laptop.svg', alt: 'A laptop computer' }, { id: 'hiking', text: 'hiking', image: 'assets/choice-hiking.svg', alt: 'A person hiking in the mountains' }, { id: 'reading', text: 'reading', image: 'assets/choice-reading.svg', alt: 'A person reading a book' }, { id: 'cycling', text: 'cycling', image: 'assets/choice-cycling.svg', alt: 'A person riding a bicycle' }, { id: 'gardening', text: 'gardening', image: 'assets/choice-gardening.svg', alt: 'A growing plant in a pot' }], correctOrder: ['hiking', 'cycling', 'gardening', 'reading', 'internet'] }
  ];
